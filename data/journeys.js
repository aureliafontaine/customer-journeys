...
window.JOURNEYS = [
  ...
  // ─── POST-PURCHASE — MYCUURE ─────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      { id: "onboarding-email",   label: "Step 3" },
      { id: "tracking-email",     label: "Step 4" },
    ...
    lanes: [
      ...
      { id: "box",    label: "Box",    type: "text", cells: {
          ...
          "onboarding-email": ["On-boarding"], "tracking-email": ["Tracking E-mail"], "unboxing": ["Unboxing"],
      ...
      { id: "multi-box", label: "Multi-box", type: "text", cells: {
          ...
          "onboarding-email": [], "tracking-email": [], "unboxing": [],
